...
a = Analysis(
    ['main.py'],
    # Корень репозитория — для пакета mektep_core и шимов (scrape_mektep и др.)
    pathex=['..'],
    binaries=[],
    ...
    hiddenimports=[
        ...
        # Scraper modules (общий пакет mektep_core + шимы совместимости в корне)
        'mektep_core',
        'mektep_core.scrape_mektep',
        'mektep_core.grade_table_signals',
        'mektep_core.iin_utils',
        'mektep_core.build_report',
        'mektep_core.build_word_report',
        'mektep_core.scraper_logger',
        'scrape_mektep',
        'grade_table_signals',
        'iin_utils',
        'build_report',
